...
public class VefiryMailsWithAttachment extends TestBase {

	@FindBy(xpath = "//*[@class='brd']")
	...
	public VefiryMailsWithAttachment() {
		PageFactory.initElements(driver, this);
	}

	public int mailsWithAttachment() throws InterruptedException {
